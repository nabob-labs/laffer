use {
    bolt_math::{MultiplyFraction, NumberConst, Udec128, Uint128},
    bolt_testing::TestBuilder,
    bolt_types::{Coins, Denom, Message, NonEmpty, QuerierExt, ResultExt},
    bolt_vm_wasm::WasmVm,
...
fn transfers() {
    ...
    // Check that sender has been given 300,000 ubolt.
    ...
    suite
        .query_wasm_smart(cfg.bank, bolt_mock_bank::QueryHoldersRequest {
            denom: DENOM.clone(),
            start_after: None,
            limit: None,
        })
