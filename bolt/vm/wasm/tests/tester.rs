...
fn infinite_loop() {
    ...
    suite
        .send_message_with_gas(
            ...
            Message::execute(
                tester,
                &bolt_tester::ExecuteMsg::InfiniteLoop {},
                Coins::new(),
            )
            .unwrap(),
        )
...
fn immutable_state() {
    ...
    // ABCI request.
    suite
        .query_wasm_smart(tester, bolt_tester::QueryForceWriteRequest {
            key: "larry".to_string(),
    ...
    suite
        .send_message_with_gas(
            ...
            Message::execute(
                tester,
                &bolt_tester::ExecuteMsg::ForceWriteOnQuery {
                    key: "larry".to_string(),
                    value: "engineer".to_string(),
                },
                Coins::new(),
...
fn query_stack_overflow() {
    ...
    suite
        .query_wasm_smart(tester, bolt_tester::QueryStackOverflowRequest {})
...
fn message_stack_overflow() {
    ...
    suite
        .send_message_with_gas(
            ...
            Message::execute(
                tester,
                &bolt_tester::ExecuteMsg::StackOverflow {},
                Coins::default(),
            )
            .unwrap(),
        )
