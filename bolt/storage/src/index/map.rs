use {
    ...
    bolt_types::{Bound, Order, Record, StdError, StdResult, Storage},
};
...
mod tests {
    use {
        ...
        bolt_types::{BorshSerExt, Bound, MockStorage, Order, StdResult},
    };
...
mod cosmwasm_tests {
    use {
        ...
        borsh::{BorshDeserialize, BorshSerialize},
        bolt_types::{BorshDeExt, BorshSerExt, Bound, MockStorage, Order, StdResult},
    };
    ...
    fn prefix_range_triple_key() {
        ...
        // Bolt implementation:
        // on bolt the prefix for (A, B, C) is A.
