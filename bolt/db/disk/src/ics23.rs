use {
    ...
    bolt_app::{Db, IbcDb},
    bolt_jmt::{ICS23_PROOF_SPEC, MerkleTree},
    bolt_types::{HashExt, Storage},
    ics23::{
...
mod tests {
    ...
    fn ics23_prove_works() {
        let path = TempDataDir::new("_bolt_disk_db_ics23_proving_works");
    ...
    fn ics23_prove_after_deletion() {
        let path = TempDataDir::new("__bolt_disk_db_ics23_prove_after_deletion");
        let db = DiskDb::open(&path).unwrap();
