...
mod __wasm_exports {
    ...
    extern "C" fn instantiate(ctx_ptr: usize, msg_ptr: usize) -> usize {
        bolt_ffi::do_instantiate(&super::instantiate, ctx_ptr, msg_ptr)
    }
    ...
    extern "C" fn bank_execute(ctx_ptr: usize, msg_ptr: usize) -> usize {
        bolt_ffi::do_bank_execute(&super::bank_execute, ctx_ptr, msg_ptr)
    }

    #[unsafe(no_mangle)]
    extern "C" fn bank_query(ctx_ptr: usize, msg_ptr: usize) -> usize {
        bolt_ffi::do_bank_query(&super::bank_query, ctx_ptr, msg_ptr)
    }
}
