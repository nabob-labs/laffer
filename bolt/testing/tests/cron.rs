...
mod tester {
    use {
        ...
        bolt_storage::Item,
        bolt_types::{Addr, Coin, Message, MutableCtx, Response, StdResult, SudoCtx},
...
mod failing_tester {
    use {
        bolt_math::{Number, NumberConst, Uint128},
        bolt_types::{Empty, MutableCtx, Response, StdResult, SudoCtx},
    };
