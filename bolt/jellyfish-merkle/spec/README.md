# Bolt JellyFish Merkle Tree Quint specification

_This document and specs were prepared by the [Informal Systems security team](https://informal.systems/security)_

This is a Quint model of a Bolt Jellyfish Merkle Tree implemented in Rust. The primary objective of this specification is to formalize the design of the Bolt Jellyfish Merkle Tree. The design is described using Quint along with the correctness conditions in the form of invariants and tests.
...
- Functionalities:
  ...
  - ICS23 proof verification in [bolt_ics23.md](./docs/bolt_ics23.md). We have described interesting test scenarios in [invariants.md](./docs/invariants.md#testing-proofs).
