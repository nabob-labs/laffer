...
pub fn process(attr: TokenStream, input: TokenStream) -> TokenStream {
    ...
    let derives = match (attrs.serde, attrs.borsh) {
        (false, true) => quote! {
            #[derive(
                ::bolt::__private::borsh::BorshSerialize,
                ::bolt::__private::borsh::BorshDeserialize,
                ::std::clone::Clone,
                ::std::fmt::Debug,
                ::std::cmp::PartialEq,
                ::std::cmp::Eq,
            )]
            #[borsh(crate = "::bolt::__private::borsh")]
        },
        (true, false) => quote! {
            #[::bolt::__private::serde_with::skip_serializing_none]
            #[derive(
                ::bolt::__private::serde::Serialize,
                ::bolt::__private::serde::Deserialize,
                ::std::clone::Clone,
                ::std::fmt::Debug,
                ::std::cmp::PartialEq,
                ::std::cmp::Eq,
            )]
            #[serde(rename_all = "snake_case", crate = "::bolt::__private::serde")]
        },
        (true, true) => quote! {
            #[::bolt::__private::serde_with::skip_serializing_none]
            #[derive(
