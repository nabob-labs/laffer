        ...
        From<GasEstimateError> + From<StdError> + From<<Self as QueryClient>::Error>,
{
    ...
    /// Send a transaction with a single [`Message::Configure`](bolt_types::Message::Configure).
    ...
    /// Send a transaction with a single [`Message::Upgrade`](bolt_types::Message::Upgrade).
    ...
    /// Send a transaction with a single [`Message::Transfer`](bolt_types::Message::Transfer).
    ...
    /// Send a transaction with a single [`Message::Upload`](bolt_types::Message::Upload).
    async fn upload<S, B>(
        &self,
        signer: &mut S,
        code: B,
    ...
    /// Send a transaction with a single [`Message::Instantiate`](bolt_types::Message::Instantiate).
    ///
    ...
    /// Send a transaction with a single [`Message::Execute`](bolt_types::Message::Execute).
    ...
    /// Send a transaction with a single [`Message::Migrate`](bolt_types::Message::Migrate).
