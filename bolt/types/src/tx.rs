...
///
/// See [Tx](https://github.com/nabob-labs/laffer/blob/main/bolt/types/src/tx.rs).
#[cfg(feature = "async-graphql")]
#[Scalar(name = "Tx")]
...
/// - List of messages to execute
///
/// See [UnsignedTx](https://github.com/nabob-labs/laffer/blob/main/bolt/types/src/tx.rs).
#[cfg(feature = "async-graphql")]
