...
pub fn init_graphql_metrics() {
    describe_histogram!(
        "http.bolt.query_app.duration",
        "Bolt query_app duration in seconds"
    );
    describe_histogram!(
        "http.bolt.query_store.duration",
        "Bolt query_store duration in seconds"
    );
    describe_histogram!(
        "http.bolt.query_status.duration",
        "Bolt query_status duration in seconds"
    );
}
