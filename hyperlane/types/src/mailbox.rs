use {
    ...
    anyhow::ensure,
    bolt::{Addr, Hash256, HexBinary, Inner},
};
...
#[bolt::derive(Serde)]
#[bolt::event("mailbox_dispatch")]
pub struct Dispatch(pub Message);

#[bolt::derive(Serde)]
#[bolt::event("mailbox_dispatch_v2")]
...
#[bolt::derive(Serde)]
#[bolt::event("mailbox_dispatch_id")]
pub struct DispatchId {
    pub message_id: Hash256,
}

#[bolt::derive(Serde)]
#[bolt::event("mailbox_process")]
pub struct Process {
    pub origin_domain: Domain,
    pub sender: Addr32,
    pub recipient: Addr32,
...
#[bolt::derive(Serde)]
#[bolt::event("mailbox_process_id")]
pub struct ProcessId {
    pub message_id: Hash256,
}

#[bolt::derive(Serde)]
#[bolt::event("post_dispatch")]
