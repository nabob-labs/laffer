...
As of today, the [protocol-owned vault](5-vault.md) is the dominant maker in Velox's markets. The [vault's inventory-skew-aware quoting policy](5-vault.md#5-market-making-policy) causes the book mid to drift from the oracle whenever the vault holds inventory:
