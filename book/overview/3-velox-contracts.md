# Velox Contract System

Velox is a suite of smart contracts that together form a perpetual
...
## 1. Shared Types (`velox/exchange/types/`)
...
## 3. Account Factory (`velox/exchange/account-factory/`)
...
## 4. Account (`velox/exchange/account/`)
...
## 6. Oracle (`velox/exchange/oracle/`)
...
## 7. Perpetual Futures Exchange (`velox/exchange/perps/`)
...
## 8. Gateway (`velox/exchange/gateway/`)
...
## 9. Vesting (`velox/exchange/vesting/`)
...
## 10. Upgrade (`velox/exchange/upgrade/`)
