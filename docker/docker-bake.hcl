...
target "cross-builder-arm64" {
  ...
  tags = ["ghcr.io/nabob-labs/laffer/cross-builder-arm64:latest"]
...
target "cross-builder-amd64" {
  ...
  dockerfile = "Dockerfile"
  tags = ["ghcr.io/nabob-labs/laffer/cross-builder-amd64:latest"]
...
target "native-builder-amd64" {
  ...
  tags = ["ghcr.io/nabob-labs/laffer/native-builder:amd64"]
...
target "native-builder-arm64" {
  ...
  tags = ["ghcr.io/nabob-labs/laffer/native-builder:arm64"]
