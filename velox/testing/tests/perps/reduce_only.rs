...
//!
//! See `velox/exchange/perps/src/trade/resize_reduce_only.rs`, `submit_order.rs`, and
//! `velox/exchange/order-book/src/matching_engine.rs`.
...
use {
    ...
    velox_testing::{TestAccount, TestOption, TestSuiteNaive, pair_id, setup_test_naive},
    velox_types::{
        constants::usdc,
