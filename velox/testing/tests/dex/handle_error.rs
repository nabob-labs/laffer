...
#[test_case(
    |contracts| {
        let bugged_dex_code = ContractBuilder::new(Box::new(velox_dex::instantiate))
...
#[test_case(
    |contracts| {
        let bugged_bank_code = ContractBuilder::new(Box::new(velox_bank::instantiate))
...
#[test_case(
    |contracts| {
        let bugged_taxman_code = ContractBuilder::new(Box::new(velox_taxman::instantiate))
