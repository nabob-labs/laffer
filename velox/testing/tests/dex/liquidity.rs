use {
    velox_dex::MINIMUM_LIQUIDITY,
    velox_oracle::PYTH_PRICES,
    velox_testing::setup_test_naive,
    velox_types::{
        config::AppConfig,
        constants::{velox, eth, usdc, xrp},
        dex::{
...
#[test_case(
    ...
    vec![
        (velox::DENOM.clone(), Udec128::new(1)),
...
#[test_case(
    ...
    vec![
        (velox::DENOM.clone(), Udec128::new(2_000_000)),
...
fn provide_liquidity(
    ...
    let lp_denom = Denom::try_from("dex/pool/velox/usdc").unwrap();
    ...
    suite
        ...
        .should_succeed_and_equal(
            expected_pool_balances
                ...
                .unwrap()
                .take_pair((velox::DENOM.clone(), usdc::DENOM.clone()))
                .unwrap(),
        );
}
...
fn withdraw_liquidity(lp_burn_amount: Uint128, swap_fee: Udec128, expected_funds_returned: Coins) {
    ...
    suite
        .query_wasm_smart(contracts.dex, velox_types::dex::QueryReserveRequest {
            base_denom: velox::DENOM.clone(),
            quote_denom: usdc::DENOM.clone(),
        })
        .should_succeed_and_equal({
    ...
    suite
        .execute(
            ...
            &dex::ExecuteMsg::WithdrawLiquidity {
                ...
                minimum_output: Some(
                    CoinPair::new(
                        Coin::new(velox::DENOM.clone(), Uint128::new(100)).unwrap(),
