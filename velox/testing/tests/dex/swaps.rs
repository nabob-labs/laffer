...
#[test_case(
    btree_map! {
        (velox::DENOM.clone(), usdc::DENOM.clone()) => coins! {
    ...
    btree_map! {
        (velox::DENOM.clone(), usdc::DENOM.clone()) => Udec128::new_permille(5),
    },
    None,
    coins! {
    ...
    btree_map! {
        (velox::DENOM.clone(), usdc::DENOM.clone()) => coins! {
            velox::DENOM.clone() => 1000000 + 1000000,
...
#[test_case(
    ...
    btree_map! {
        (velox::DENOM.clone(), usdc::DENOM.clone()) => coins! {
            velox::DENOM.clone() => 1000000 + 500000,
...
#[test_case(
    ...
    btree_map! {
        (velox::DENOM.clone(), usdc::DENOM.clone()) => coins! {
            velox::DENOM.clone() => 1000000 + 331666,
...
#[test_case(
    ...
    btree_map! {
        (velox::DENOM.clone(), usdc::DENOM.clone()) => Udec128::new_bps(1),
    },
    None,
    coins! {
...
#[test_case(
    ...
    coins! {
        velox::DENOM.clone() => 1002007,
    },
    btree_map! {
        (velox::DENOM.clone(), usdc::DENOM.clone()) => Udec128::new_permille(1),
    },
    Coin::new(velox::DENOM.clone(), 1002007).unwrap(),
    Coin::new(usdc::DENOM.clone(), 2000).unwrap(),
    btree_map! {
        (velox::DENOM.clone(), usdc::DENOM.clone()) => coins! {
            velox::DENOM.clone() => 1000000 + 1002007,
...
#[test_case(
    ...
    coins! {
        velox::DENOM.clone() => 500752,
    },
    btree_map! {
        (velox::DENOM.clone(), usdc::DENOM.clone()) => Udec128::new_permille(1),
    },
    Coin::new(velox::DENOM.clone(), 500752).unwrap(),
    Coin::new(usdc::DENOM.clone(), 1334).unwrap(),
    btree_map! {
        (velox::DENOM.clone(), usdc::DENOM.clone()) => coins! {
            velox::DENOM.clone() => 1000000 + 500752,
...
#[test_case(
    ...
    coins! {
        velox::DENOM.clone() => 333780,
    },
    btree_map! {
        (velox::DENOM.clone(), usdc::DENOM.clone()) => Udec128::new_permille(1),
    },
    Coin::new(velox::DENOM.clone(), 333780).unwrap(),
    Coin::new(usdc::DENOM.clone(), 1000).unwrap(),
    btree_map! {
        (velox::DENOM.clone(), usdc::DENOM.clone()) => coins! {
            velox::DENOM.clone() => 1000000 + 333780,
...
#[test_case(
    ...
    Coin::new(velox::DENOM.clone(), 1000000).unwrap(),
...
#[test_case(
    ...
    Coin::new(velox::DENOM.clone(), 501761).unwrap(),
    Coin::new(eth::DENOM.clone(), 1000).unwrap(),
    btree_map! {
        (velox::DENOM.clone(), usdc::DENOM.clone()) => coins! {
            velox::DENOM.clone() => 1000000 + 501761,
...
fn geometric_pool_swaps_fail_without_oracle_price() {
    ...
    suite
        ...
        .should_fail_with_error(StdError::data_not_found::<PriceSource>(
            PRICE_SOURCES.path(&velox::DENOM).storage_key(),
        ));
    ...
    suite
        .execute(
            ...
            &dex::ExecuteMsg::SwapExactAmountOut {
                ...
                output: NonZero::new(Coin::new(velox::DENOM.clone(), 50000).unwrap()).unwrap(),
            },
            coins! {
                usdc::DENOM.clone() => 1000000,
            },
