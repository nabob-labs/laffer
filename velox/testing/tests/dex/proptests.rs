use {
    ...
    velox_types::{
        constants::{velox, velox_usdc, eth, eth_usdc, sol, sol_usdc, usdc},
        dex::{
...
fn bucket_sizes() -> BTreeMap<PairId, BTreeSet<NonZero<Price>>> {
    btree_map! {
        PairId {
            ...
            velox_usdc::ONE_THOUSANDTH,
            velox_usdc::ONE_HUNDREDTH,
            velox_usdc::ONE_TENTH,
            velox_usdc::ONE,
            velox_usdc::TEN,
            velox_usdc::FIFTY,
            velox_usdc::ONE_HUNDRED,
        },
        PairId {
            base_denom: sol::DENOM.clone(),
            quote_denom: usdc::DENOM.clone(),
    ...
    for denom in denoms() {
        suite
            .execute(
                &mut accounts.owner,
                contracts.oracle,
                &velox_types::oracle::ExecuteMsg::RegisterPriceSources(btree_map! {
                    denom => velox_types::oracle::PriceSource::Fixed {
