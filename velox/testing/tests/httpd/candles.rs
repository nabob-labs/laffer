use {
    ...
    velox_graphql_types::{Candles, SubscribeCandles, candles, subscribe_candles},
    ...
    local_set
        .run_until(async {
            tokio::task::spawn_local(async move {
                ...
                assert_that!(candle.base_denom.as_str()).is_equal_to("velox");
...
async fn graphql_subscribe_to_candles() -> anyhow::Result<()> {
    ...
    let context = velox_httpd_context.clone();
        ...
        .run_until(async {
            tokio::task::spawn_local(async move {
                ...
                fn verify_candle(
                    ...
                    assert_eq!(candle.base_denom, "velox");
