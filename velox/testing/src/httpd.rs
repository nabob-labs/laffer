use {
    ...
    velox_genesis::{Codes, Contracts, GenesisCodes, GenesisOption},
    velox_indexer_hooked::HookedIndexer,
    velox_primitives::HttpdConfig,
    velox_proposal_preparer::ProposalPreparer,
    velox_vm_rust::{ContractWrapper, RustVm},
};
...
where
    C: FnOnce(
            ...
            Contracts,
            MockValidatorSets,
            velox_indexer_sql::context::Context,
        ) + Send
        + Sync,
{
    let indexer = velox_indexer_sql::IndexerBuilder::default();
    ...
    let indexer_clickhouse_context = velox_indexer_clickhouse::context::Context::new(
    ...
    let clickhouse_indexer =
        velox_indexer_clickhouse::indexer::Indexer::new(indexer_clickhouse_context.clone());
    ...
    velox_indexer_httpd::server::run_server(
        &httpd_config,
        velox_httpd_context,
        shutdown_flag,
        port_sender,
