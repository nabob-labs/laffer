use {
    ...
    velox_indexer_httpd::traits::QueryApp,
    velox_math::Uint128,
    velox_primitives::{
...
type PythProposalPreparer = velox_proposal_preparer::ProposalPreparer<PythClientCache>;
    ...
    AppError: From<DB::Error> + From<VM::Error> + From<PP::Error>,
{
    ...
    pub fn new_with_db_vm_indexer_and_pp(
        ...
        // This is doing the same order as in Velox.
