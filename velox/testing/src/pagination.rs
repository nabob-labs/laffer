pub use velox_indexer_graphql_types::{
...
/// with `velox_indexer_httpd::context::FullContext`.
///
/// ## Arguments
///
/// - `$fn_name` - The name of the generated function
/// - `$context_type` - The context type (e.g., `velox_indexer_httpd::context::FullContext`)
/// - `$query_type` - The GraphQL query type (e.g., `Blocks`)
/// - `$module` - The module containing the query types (e.g., `velox_indexer_graphql_types::blocks`)
