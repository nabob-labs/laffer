use {
    ...
    velox_genesis::{
        ...
        BoltOption, HyperlaneOption, OracleOption, PerpsOption, VestingOption,
    },
    velox_order_book::{Dimensionless, Quantity, UsdPrice},
    velox_types::{
        account_factory::NewUserSalt,
        auth::Key,
        bank::Metadata,
        constants::{
            PYTH_PRICE_SOURCES, atom, bch, bnb, btc, btc_usdc, velox, doge, eth, eth_usdc, ltc,
        ...
        AccountOption {
            genesis_users: vec![
                GenesisUser {
                    ...
                    velox_balance: Uint128::new(100_000_000_000_000),
                },
                GenesisUser {
                    salt: NewUserSalt {
                    ...
                    velox_balance: Uint128::new(1_000_000_000_000_000_000),
                },
                GenesisUser {
                    salt: NewUserSalt {
...
impl Preset for BankOption {
    fn preset_test() -> Self {
        BankOption {
            metadatas: btree_map! {
                velox::DENOM.clone() => Metadata {
                    name: LengthBounded::new_unchecked("Velox".to_string()),
                    symbol: LengthBounded::new_unchecked("DGX".to_string()),
                    decimals: velox::DECIMAL,
                    description: Some(LengthBounded::new_unchecked("Native token of Velox".to_string())),
                },
            ...
            pairs: vec![
                PairUpdate {
                    ...
                    params: PairParams {
                        ...
                        bucket_sizes: BTreeSet::new(), /* TODO: determine appropriate price buckets based on expected velox token price */
