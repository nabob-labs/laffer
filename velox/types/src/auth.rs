...
/// Data that the account expects for the transaction's [`credential`](bolt::Tx::credential)
/// field.
#[bolt::derive(Serde)]
pub enum Signature {
...
/// Data that the account expects for the transaction's [`data`](bolt::Tx::data)
/// field.
#[bolt::derive(Serde)]
pub struct Metadata {
