use {
    bolt::{Binary, Inner, PrimaryKey, RawKey, StdError, StdResult},
...
pub enum Remote {
    ...
    /// Indicates the token was received through Velox's proprietary bitcoin bridge.
    Bitcoin,
}
...
impl PrimaryKey for Remote {
    ...
    fn raw_keys(&self) -> Vec<bolt::RawKey<'_>> {
