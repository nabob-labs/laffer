use {
    ...
    bolt::{Addr, Bounded, Coins, Udec128, ZeroInclusiveOneExclusive, coins},
};

/// Application-specific configurations of the Velox chain.
#[bolt::derive(Serde)]
pub struct AppConfig {
    /// Addresses of relevant Velox contracts.
