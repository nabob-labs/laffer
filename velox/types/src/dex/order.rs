use {
    ...
    bolt::{Addr, MathResult, Number, NumberConst, Udec128_6, Uint64, Uint128},
};
...
///
/// See `velox_dex::state::OrderKey` for details.
///
...
/// use `bolt::Uint64`, which is serialized as JSON strings.
pub type OrderId = Uint64;

#[bolt::derive(Borsh, Serde)]
#[derive(Copy)]
pub struct Order {
