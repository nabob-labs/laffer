use {
    ...
    url::Url,
    velox_indexer_graphql_types::Variables,
};
...
impl SubscriptionVariables for velox_indexer_graphql_types::subscribe_block::Variables {}
impl SubscriptionVariables for velox_indexer_graphql_types::subscribe_accounts::Variables {}
impl SubscriptionVariables for velox_indexer_graphql_types::subscribe_transfers::Variables {}
impl SubscriptionVariables for velox_indexer_graphql_types::subscribe_transactions::Variables {}
impl SubscriptionVariables for velox_indexer_graphql_types::subscribe_messages::Variables {}
impl SubscriptionVariables for velox_indexer_graphql_types::subscribe_events::Variables {}
impl SubscriptionVariables
    for velox_indexer_graphql_types::subscribe_event_by_addresses::Variables
{
}
impl SubscriptionVariables for velox_indexer_graphql_types::subscribe_perps_candles::Variables {}
// `perps_events` is served over the native WebSocket `/ws` endpoint — see
// `WsConnection::subscribe_perps_events`.
impl SubscriptionVariables for velox_indexer_graphql_types::subscribe_perps_trades::Variables {}
impl SubscriptionVariables for velox_indexer_graphql_types::subscribe_query_app::Variables {}
impl SubscriptionVariables for velox_indexer_graphql_types::subscribe_query_status::Variables {}
