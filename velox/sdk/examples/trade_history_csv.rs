...
//! Velox indexer and write it to a CSV file.
//!
...
//!
//! ```sh
//! cargo run -p velox-sdk --example trade_history_csv
//! ```
...
use {
    ...
    velox_sdk::{HttpClient, PageInfo, perps_events},
    velox_types::perps::OrderFilled,
};

const HTTP_URL: &str = "https://api-mainnet.velox.zone";
