//! Subscribe to BTC perps events on Velox testnet over the multiplexed native
...
//!
//! ```sh
//! cargo run -p velox-sdk --example subscribe_perps_events
//! ```

use {
    anyhow::Result,
    futures::StreamExt,
    velox_order_book::{OrderPersisted, OrderRemoved, OrderResized},
    velox_primitives::EventName,
    velox_sdk::WsConnection,
    velox_types::{
        constants::perp_btc,
