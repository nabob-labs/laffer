...
/// [`velox/perps/purity.md`](../../purity.md) for the full rationale.
#[derive(Debug)]
...
/// caller's inputs untouched — see `velox/perps/purity.md`.
///
...
/// the caller's inputs untouched — see `velox/perps/purity.md`.
///
