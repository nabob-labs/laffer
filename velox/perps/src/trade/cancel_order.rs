use {
    ...
    velox_types::perps::{PairParam, UserState},
    bolt::{Addr, EventBuilder, MutableCtx, Order as IterationOrder, Response, StdResult, Storage},
...
/// `outcome.user_state`. See `velox/perps/purity.md` for the full
/// rationale.
...
mod tests {
    use {
        ...
        velox_types::perps::{PairParam, Position, UserState},
        bolt::{
