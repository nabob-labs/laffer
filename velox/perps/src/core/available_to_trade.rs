...
use {
    ...
    velox_order_book::{Dimensionless, PairId, Quantity, UsdValue},
...
///   [`OracleQuerier::query_price_for_perps`]. Velox uses the oracle price
...
mod tests {
    use {
        ...
        velox_order_book::{FundingPerUnit, UsdPrice},
        velox_types::{
            constants::{btc, eth},
