use {
    ...
    anyhow::ensure,
    velox_order_book::{Dimensionless, FundingRate, PairId, UsdPrice, UsdValue},
    velox_types::perps::{PairParam, PairState, Param, RateSchedule},
    bolt::{Duration, GENESIS_SENDER, MutableCtx, QuerierExt, Response},
...
///
/// Bounds are documented on each field in `velox_types::perps::Param`.
...
///
/// Bounds are documented on each field in `velox_types::perps::PairParam`.
...
mod tests {
    use {
        super::*,
        velox_order_book::{FundingRate, Quantity},
        bolt::{Duration, Number as _, btree_map, btree_set},
    };
