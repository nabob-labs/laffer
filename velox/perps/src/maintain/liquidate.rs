...
/// buffers, so the pragmatic exception in `velox/perps/purity.md`
...
mod tests {
    use {
        ...
        velox_types::perps::{PairParam, PairState, Param, Position, State, UserState},
        bolt::{Addr, Coins, MockContext, Storage, Timestamp, Uint64},
        std::collections::BTreeMap,
    };
    ...
    fn save_bid(
        ...
        use velox_order_book::may_invert_price;
    ...
    fn mock_oracle_querier(pairs: Vec<(PairId, i128)>) -> OracleQuerier<'static> {
        use {velox_types::oracle::PrecisionedPrice, bolt::Udec128};
