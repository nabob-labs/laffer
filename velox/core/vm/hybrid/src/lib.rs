use {
    ...
    velox_app::{AppError, GasTracker, Instance, QuerierProvider, StorageProvider, Vm},
    velox_backtrace::Backtraceable,
    velox_primitives::{Context, Hash256},
    velox_vm_rust::{RustInstance, RustVm},
    velox_vm_wasm::{WasmInstance, WasmVm},
};
...
pub enum VmError {
    ...
    Rust(velox_vm_rust::VmError),

    #[error("WasmVm error: {0}")]
    Wasm(velox_vm_wasm::VmError),
}
