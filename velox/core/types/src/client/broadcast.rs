use {
    ...
    serde::Serialize,
    velox_backtrace::BacktracedError,
};
        ...
        From<GasEstimateError> + From<StdError> + From<<Self as QueryClient>::Error>,
{
    ...
    /// Send a transaction with a single [`Message::Configure`](velox_primitives::Message::Configure).
    ...
    /// Send a transaction with a single [`Message::Upgrade`](velox_primitives::Message::Upgrade).
    ...
    /// Send a transaction with a single [`Message::Transfer`](velox_primitives::Message::Transfer).
    ...
    /// Send a transaction with a single [`Message::Upload`](velox_primitives::Message::Upload).
    async fn upload<S, B>(
        &self,
        signer: &mut S,
        code: B,
    ...
    /// Send a transaction with a single [`Message::Instantiate`](velox_primitives::Message::Instantiate).
    ///
    ...
    /// Send a transaction with a single [`Message::Execute`](velox_primitives::Message::Execute).
    ...
    /// Send a transaction with a single [`Message::Migrate`](velox_primitives::Message::Migrate).
