use {
    ...
    velox_primitives::{Binary, Empty, Query, QueryResponse},
};
...
#[velox_primitives::derive(Serde, Borsh, QueryRequest)]
pub enum QueryMsg {
    #[returns(())]
    ...
    ///
    /// If using the Velox library, this is impossible to do, because the
