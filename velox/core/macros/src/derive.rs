...
pub fn process(attr: TokenStream, input: TokenStream) -> TokenStream {
    ...
    let derives = match (attrs.serde, attrs.borsh) {
        (false, true) => quote! {
            #[derive(
                ::velox_primitives::__private::borsh::BorshSerialize,
                ::velox_primitives::__private::borsh::BorshDeserialize,
                ::std::clone::Clone,
                ::std::fmt::Debug,
                ::std::cmp::PartialEq,
                ::std::cmp::Eq,
            )]
            #[borsh(crate = "::velox_primitives::__private::borsh")]
        },
        (true, false) => quote! {
            #[::velox_primitives::__private::serde_with::skip_serializing_none]
            #[derive(
                ::velox_primitives::__private::serde::Serialize,
                ::velox_primitives::__private::serde::Deserialize,
                ::std::clone::Clone,
                ::std::fmt::Debug,
                ::std::cmp::PartialEq,
                ::std::cmp::Eq,
            )]
            #[serde(rename_all = "snake_case", crate = "::velox_primitives::__private::serde")]
        },
        (true, true) => quote! {
            #[::velox_primitives::__private::serde_with::skip_serializing_none]
            #[derive(
    ...
    let query_derive = if attrs.query {
        quote! {
            #[derive(::velox_primitives::QueryRequest)]
        }
    } else {
        quote! {}
    };
