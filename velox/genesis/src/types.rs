use {
    ...
    bolt::{Addr, Binary, Coin, Coins, Denom, Duration, Timestamp, Uint128},
...
pub struct DexOption {
    /// Initial Velox DEX trading pairs.
...
pub struct VestingOption {
    /// Cliff for Velox token unlocking.
    pub unlocking_cliff: Duration,
    /// Period for Velox token unlocking.
