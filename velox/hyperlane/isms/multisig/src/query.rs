...
mod tests {
    use {
        ...
        rand::rngs::OsRng,
        test_case::test_case,
        velox_hyperlane_types::{Addr32, IncrementalMerkleTree, addr32, mailbox::MAILBOX_VERSION},
        velox_identity::Identity256,
        velox_primitives::{Inner, MockContext, ResultExt, btree_set},
    };
    ...
    fn rejecting_malleable_duplicate_signatures() {
        ...
        malleable[64] = if v == 27 { 28 } else { 27 }; // flipped recovery id
