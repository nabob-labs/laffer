use {
    ...
    anyhow::ensure,
    velox_primitives::{Addr, Hash256, HexBinary, Inner},
};
...
#[velox_primitives::derive(Serde)]
#[velox_primitives::event("mailbox_dispatch")]
pub struct Dispatch(pub Message);

#[velox_primitives::derive(Serde)]
#[velox_primitives::event("mailbox_dispatch_v2")]
...
#[velox_primitives::derive(Serde)]
#[velox_primitives::event("mailbox_dispatch_id")]
pub struct DispatchId {
    pub message_id: Hash256,
}

#[velox_primitives::derive(Serde)]
#[velox_primitives::event("mailbox_process")]
pub struct Process {
    pub origin_domain: Domain,
    pub sender: Addr32,
    pub recipient: Addr32,
...
#[velox_primitives::derive(Serde)]
#[velox_primitives::event("mailbox_process_id")]
pub struct ProcessId {
    pub message_id: Hash256,
}

#[velox_primitives::derive(Serde)]
#[velox_primitives::event("post_dispatch")]
...
#[velox_primitives::derive(Serde)]
#[velox_primitives::event("inserted_into_tree")]
