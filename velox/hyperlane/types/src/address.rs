use {
    ...
    velox_primitives::{Addr, EncodedBytes, HexEncoder, Inner, StdResult},
    velox_storage::{PrimaryKey, RawKey},
};

#[macro_export]
macro_rules! addr32 {
    ($hex_str:literal) => {
        $crate::Addr32::from_inner(::velox_primitives::__private::hex_literal::hex!($hex_str))
    };
}
