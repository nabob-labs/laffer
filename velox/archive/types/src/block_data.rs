use velox_primitives::FullBlock;
...
///
/// This is the node's own [`velox_primitives::FullBlock`], reused directly
...
/// - **On-disk format.** `FullBlock` derives borsh, the same format the velox
...
///
/// [`BlockSource`]: velox_archive_block_source::BlockSource
