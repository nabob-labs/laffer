use {
    ...
    std::sync::Arc,
    velox_archive_block_source::BlockSource,
    velox_archive_httpd::{Configurator, HttpdConfig, serve},
    velox_archive_projection::{Committer, Projection},
    velox_archive_types::AnyResult,
};
...
/// [`serve`](velox_archive_httpd::serve) task along with the shared
