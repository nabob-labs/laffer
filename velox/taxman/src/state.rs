use {
    velox_types::{account_factory::UserIndex, taxman::Config},
    bolt::{Item, Map, Timestamp, Udec128_6, Uint128},
};
...
///
/// In Velox, this is used to determine a user's trading fee. The higher the
