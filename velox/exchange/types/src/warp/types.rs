use {
    anyhow::ensure,
    velox_hyperlane_types::Addr32,
    velox_math::{Bytable, NextNumber, PrevNumber, Uint128, Uint256},
    velox_primitives::{HexBinary, Inner},
};
...
pub struct TokenMessage {
    ...
    // Note: In Velox we use `Uint128` to represent token amounts, but the Warp
