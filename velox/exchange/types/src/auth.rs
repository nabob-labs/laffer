...
/// Data that the account expects for the transaction's [`credential`](velox_primitives::Tx::credential)
/// field.
...
/// Data that the account expects for the transaction's [`data`](velox_primitives::Tx::data)
/// field.
#[velox_primitives::derive(Serde)]
pub struct Metadata {
