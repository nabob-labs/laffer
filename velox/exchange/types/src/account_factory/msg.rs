use {
    ...
    velox_primitives::{Addr, Hash256, JsonSerExt, Op, SignData, StdError, StdResult},
};
...
pub struct InstantiateMsg {
    /// Code hash to be associated with the Velox account contract.
...
pub enum QueryMsg {
    /// Query the code hash associated with the Velox account contract.
    #[returns(Hash256)]
    CodeHash {},
