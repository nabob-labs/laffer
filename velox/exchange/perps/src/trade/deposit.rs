use {
    ...
    anyhow::ensure,
    velox_math::IsZero,
    velox_order_book::Quantity,
    velox_primitives::{Addr, MutableCtx, Response},
    velox_types::perps::{Deposited, SETTLEMENT_CURRENCY_PRICE, settlement_currency},
};
...
mod tests {
    use {
        ...
        velox_primitives::{Addr, Coins, MockContext, ResultExt},
    };
