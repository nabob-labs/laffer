use {
    ...
    velox_primitives::{Addr, Timestamp},
    velox_storage::{IndexedMap, Item, Map, MultiIndex, Set},
    velox_types::{
...
#[velox_storage::index_list(Addr, UserState)]
...
#[velox_storage::index_list((Referrer, Referee), RefereeStats)]
