...
use {
    ...
    velox_order_book::{FillId, NEXT_FILL_ID, NEXT_ORDER_ID, OrderId, UsdValue},
    velox_primitives::{
...
#[inline]
fn oracle(querier: impl VeloxQuerier) -> Addr {
    #[cfg(not(debug_assertions))]
    {
        let _ = querier;
        velox_primitives::addr!("cedc5f73cbb963a48471b849c3650e6e34cd3b6d")
    }
...
#[inline]
fn account_factory(querier: impl VeloxQuerier) -> Addr {
    #[cfg(not(debug_assertions))]
    {
        let _ = querier;
        velox_primitives::addr!("18d28bafcdf9d4574f920ea004dea2d13ec16f6b")
    }
...
mod tests {
    use {
        ...
        velox_primitives::{Coins, Json, MockContext, NonEmpty, ResultExt},
    };
