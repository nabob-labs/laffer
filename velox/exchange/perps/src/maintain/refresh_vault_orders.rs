...
mod tests {
    ...
    fn mock_config() -> Config {
        Config {
            owner: OWNER,
            bank: Addr::mock(3),
            gas_token: velox_primitives::Denom::new_unchecked(["ugas"]),
    ...
    fn mock_querier() -> MockQuerier {
        MockQuerier::new()
            .with_app_config(AppConfig {
                addresses: velox_types::config::AppAddresses {
                    oracle: ORACLE,
                    ..Default::default()
                },
                ..Default::default()
