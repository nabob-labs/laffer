pub const LABEL_TRADES: &str = "velox.contract.dex.trades_count";

pub const LABEL_ORDERS_FILLED: &str = "velox.contract.dex.orders_filled_count";

pub const LABEL_CONTRACT_AMOUNT: &str = "velox.contract.dex.contract_amount";

pub const LABEL_CONTRACT_VALUE: &str = "velox.contract.dex.contract_value";

pub const LABEL_RESERVE_AMOUNT: &str = "velox.contract.dex.reserve_amount";

pub const LABEL_RESERVE_VALUE: &str = "velox.contract.dex.reserve_value";

pub const LABEL_TRADES_PER_BLOCK: &str = "velox.contract.dex.trades_per_block";

pub const LABEL_VOLUME_PER_TRADE: &str = "velox.contract.dex.volume_per_trade";

pub const LABEL_VOLUME_AMOUNT_PER_BLOCK: &str = "velox.contract.dex.volume_amount_per_block";

pub const LABEL_VOLUME_VALUE_PER_BLOCK: &str = "velox.contract.dex.volume_value_per_block";

pub const LABEL_BEST_PRICE: &str = "velox.contract.dex.best_price";

pub const LABEL_SPREAD_ABSOLUTE: &str = "velox.contract.dex.spread_absolute";

pub const LABEL_SPREAD_PERCENTAGE: &str = "velox.contract.dex.spread_percentage";

pub const LABEL_DURATION_AUCTION: &str = "velox.contract.dex.auction.duration";

pub const LABEL_DURATION_REFLECT_CURVE: &str = "velox.contract.dex.reflect_curve.duration";

pub const LABEL_DURATION_ORDER_MATCHING: &str = "velox.contract.dex.order_matching.duration";

pub const LABEL_DURATION_ORDER_FILLING: &str = "velox.contract.dex.order_filling.duration";

pub const LABEL_DURATION_CANCEL_IOC: &str = "velox.contract.dex.cancel_ioc.duration";

pub const LABEL_DURATION_UPDATE_REST_STATE: &str = "velox.contract.dex.update_rest_state.duration";

pub const LABEL_DURATION_ITER_NEXT: &str = "velox.contract.dex.iterator_next.duration";
...
pub mod emit {
    use {
        velox_oracle::OracleQuerier,
        velox_types::{dex::Price, oracle::PrecisionedPrice},
        bolt::{
