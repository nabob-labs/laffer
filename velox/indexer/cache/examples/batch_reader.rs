...
//! `velox-testnet-batches` bucket and streams them through
...
//! S3_ACCESS_KEY=...
//! S3_SECRET_KEY=...
//! S3_BUCKET=velox-testnet-batches   # optional, this is the default
...
//!
//! ```text
//! cargo run -p velox-indexer-cache --example batch_reader --features s3,xz-codec
//! ```
...
async fn main() -> anyhow::Result<()> {
    ...
    let cfg = S3Config {
        ...
        bucket: optional_env("S3_BUCKET", "velox-testnet-batches"),
