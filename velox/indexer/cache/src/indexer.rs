use {
    ...
    velox_primitives::BlockAndBlockOutcomeWithHttpDetails,
};
...
use velox_primitives::{Hash256, HttpRequestDetails};
...
impl Cache {
    ...
    fn set_http_request_details(
        &self,
        block: &velox_primitives::Block,
    ) -> velox_app::IndexerResult<HashMap<Hash256, HttpRequestDetails>> {
        ...
        let mut transaction_hash_details = self
            ...
            .lock()
            .map_err(|_| velox_app::IndexerError::mutex_poisoned())?;
...
impl Cache {
    pub async fn start(
        &mut self,
        _storage: &dyn velox_primitives::Storage,
    ...
    pub async fn pre_indexing(&self, block_height: u64) -> velox_app::IndexerResult<()> {
    ...
    pub async fn index_block(
        &self,
        block: &velox_primitives::Block,
        block_outcome: &velox_primitives::BlockOutcome,
    ) -> velox_app::IndexerResult<()> {
    ...
    pub async fn post_indexing(
        &self,
        block_height: u64,
    ) -> velox_app::IndexerResult<BlockAndBlockOutcomeWithHttpDetails> {
        let Some(data) = self
            .blocks
            .lock()
            .map_err(|_| velox_app::IndexerError::mutex_poisoned())?
            ...
            return Err(velox_app::IndexerError::hook(format!(
