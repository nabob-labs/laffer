use {
    ...
    velox_primitives::{Addr, Block, BlockOutcome, Config, FullBlock, Json, JsonDeExt},
...
/// [`velox_app::Indexer`], it does no durable indexing: it maintains an
...
#[async_trait]
impl velox_app::Indexer for Indexer {
    fn name(&self) -> &'static str {
        "velox-indexer-stream"
    }
...
mod tests {
    use {
        ...
        velox_app::Indexer as _,
        velox_primitives::{BlockInfo, Hash256, Timestamp},
    };
