...
//! [`velox_indexer_stream::Context`]; only the framing differs from the SSE and
...
use {
    ...
    velox_indexer_stream::{Context, make_perps_filter},
    velox_primitives::{HttpRequestDetails, Tx},
};
