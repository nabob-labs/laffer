...
mod tests {
    use {
        ...
        bolt::{NumberConst, Udec128_6, Udec128_24},
        itertools::Itertools,
    ...
    fn pair_price(
        ...
        Ok(PairPrice {
            quote_denom: quote_denom.to_string(),
            base_denom: base_denom.to_string(),
            clearing_price: Udec128_24::raw(bolt::Int::new(clearing_price)),
            volume_base: Udec128_6::raw(bolt::Int::new(volume_base)),
            volume_quote: Udec128_6::raw(bolt::Int::new(volume_quote)),
