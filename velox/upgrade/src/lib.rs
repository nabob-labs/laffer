use {
    velox_order_book::{ASKS, BIDS, increase_liquidity_depths, may_invert_price},
    velox_perps::state::{PAIR_IDS, PAIR_PARAMS},
    bolt::{Addr, BlockInfo, Order, StdResult, Storage, addr},
    bolt_app::{AppResult, CHAIN_ID, CONTRACT_NAMESPACE, StorageProvider},
    std::collections::BTreeSet,
};

const MAINNET_CHAIN_ID: &str = "velox-1";
const MAINNET_PERPS_ADDRESS: Addr = addr!("90bc84df68d1aa59a857e04ed529e9a26edbea4f");

const TESTNET_CHAIN_ID: &str = "velox-testnet-1";
...
mod tests {
    use {
        ...
        velox_perps::state::{PAIR_IDS, PAIR_PARAMS},
        velox_types::perps::PairParam,
        bolt::{Addr, Dec128_6, MockStorage, Order, StdResult, Storage, Timestamp, Uint64},
