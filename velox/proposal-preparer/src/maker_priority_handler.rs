use {
    ...
    bolt::{Addr, Inner, JsonDeExt, Message, QuerierExt, QuerierWrapper, StdError, Tx},
    prost::bytes::Bytes,
};
...
impl bolt_app::ProposalPreparer for MakerPriorityHandler {
    type Error = StdError;
...
mod tests {
    use {
        ...
        bolt::{Coins, Json, JsonSerExt, MsgExecute, NonEmpty, Uint64},
        test_case::test_case,
    };
