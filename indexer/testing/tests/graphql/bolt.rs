use {
    ...
    assertor::*,
    velox_graphql_types::{QueryApp, SubscribeQueryApp, query_app, subscribe_query_app},
        ...
        .run_until(async {
            tokio::task::spawn_local(async move {
                ...
                assert_json_eq!(
                    ...
                    json!({"balance": {"amount": "0", "denom": "ubolt"}})
                );
                ...
                assert_json_eq!(
                    response.data.response,
                    json!({"balance": {"amount": "2000", "denom": "ubolt"}})
                );
                ...
                assert_json_eq!(
                    response.data.response,
                    json!({"balance": {"amount": "4000", "denom": "ubolt"}})
                );
