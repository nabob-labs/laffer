use {
    ...
    bolt_httpd::{context::Context as BaseContext, traits::QueryApp},
...
impl Context {
    ...
    pub fn bolt_app(&self) -> &Arc<dyn QueryApp + Send + Sync> {
        &self.base.bolt_app
    }
}
