use {
    ...
    bolt_types::BlockAndBlockOutcomeWithHttpDetails,
...
use bolt_types::{Hash256, HttpRequestDetails};
...
impl Cache {
    ...
    fn set_http_request_details(
    ...
    ) -> bolt_app::IndexerResult<HashMap<Hash256, HttpRequestDetails>> {
        ...
        let mut transaction_hash_details = self
            ...
            .lock()
            .map_err(|_| bolt_app::IndexerError::mutex_poisoned())?;
...
#[async_trait]
impl bolt_app::Indexer for Cache {
    ...
    async fn post_indexing(
        &self,
        block_height: u64,
        _cfg: bolt_types::Config,
        _app_cfg: bolt_types::Json,
        ctx: &mut bolt_app::IndexerContext,
    ) -> bolt_app::IndexerResult<()> {
        let Some(data) = self
            .blocks
            ...
            return Err(bolt_app::IndexerError::hook(format!(
