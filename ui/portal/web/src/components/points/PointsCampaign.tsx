...
import { useAccount, useBoxes, useOats } from "@laffer/store";
...
const PointsCampaignHeader: React.FC = () => (
  <div className="flex flex-col gap-8 w-full items-center relative">
        ...
        {(() => {
          ...
          return (
            <span className="flex items-center">
              {parts[0]}
              <IconVeloxStick className="inline-block h-[2.7rem] w-auto -mx-[0.6rem]" />
              {parts[1]}
            </span>
          );
        })()}
    ...
    <Button
      variant="utility"
      onClick={() => window.open("https://velox-4.gitbook.io/velox-docs/points")}
    >
