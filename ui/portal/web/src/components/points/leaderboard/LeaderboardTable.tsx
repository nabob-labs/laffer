import { Cell, FormattedNumber, Pagination, SortHeader, Tab, Table, Tabs } from "@laffer/applets-kit";
import { m } from "@laffer/foundation/paraglide/messages.js";
import { useAccount, useLeaderboard } from "@laffer/store";
import { useMemo } from "react";

import type { TableColumn } from "@laffer/applets-kit";
import type { LeaderboardTimeframe } from "@laffer/store";
...
export const LeaderboardTable: React.FC = () => {
  ...
  const pointsUrl = window.velox.urls.pointsUrl;
