import { useConfig } from "@laffer/store";
import { Modals, useApp } from "@laffer/applets-kit";
import { useRouter } from "@tanstack/react-router";
import { forwardRef, useImperativeHandle } from "react";

import { OrderActivity } from "./OrderActivity";
import { PairAssets, twMerge } from "@laffer/applets-kit";
import { Direction, OrderType, TimeInForceOption } from "@laffer/velox/types";

import { calculatePrice, Decimal, formatNumber, formatUnits } from "@laffer/velox/utils";
import { m } from "@laffer/foundation/paraglide/messages.js";

import type { ActivityRef } from "./Activity";
import type { ActivityRecord } from "@laffer/store";
