...
import { Decimal, formatUnits, parseUnits } from "@laffer/velox/utils";
...
import type { NonNullablePropertiesBy } from "@laffer/velox/types";
  ...
  return (
    <>
      <CoinSelector
        ...
        coins={coins.filter(
          (c) =>
            (chain.id === "velox-1" && c.name !== "Ether" && action === "deposit") ||
            action === "withdraw",
        )}
        withName
        withPrice
