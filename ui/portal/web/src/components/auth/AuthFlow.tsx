import { useAuthState, useConnectors } from "@laffer/store";
import type { AuthScreen } from "@laffer/store";
...
import { VeloxLogo } from "../foundation/VeloxLogo";
  ...
  return (
    <>
      <div className="flex flex-col gap-7 items-center justify-center w-full text-center">
        <VeloxLogo className="h-[60px]" />
        <h1 className="h2-heavy">{m["common.welcomeToVelox"]()}</h1>
      </div>
