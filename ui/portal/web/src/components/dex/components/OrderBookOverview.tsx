import { FormattedNumber, Select, Spinner, useApp, useMediaQuery } from "@laffer/applets-kit";
import { useDeferredValue, useEffect, useMemo, useRef, useState } from "react";
import { useRouter } from "@tanstack/react-router";

import { Direction, type PairId } from "@laffer/velox/types";
import {
  liquidityDepthStore,
...
import {
  ...
  formatNumber,
  parseUnits,
} from "@laffer/velox/utils";

import { IconLink, ResizerContainer, Tabs, twMerge, formatDate } from "@laffer/applets-kit";
import { m } from "@laffer/foundation/paraglide/messages.js";

import type React from "react";
import type { AnyCoin } from "@laffer/store/types";
import type { Controllers } from "@laffer/applets-kit";
