import { useAppConfig, useConfig, perpsMarginAsset, TradePairStore } from "@laffer/store";
import { useRef, useState } from "react";

import { IconSearch, Input, Popover, /* Tabs, */ useMediaQuery } from "@laffer/applets-kit";
import { Sheet } from "react-modal-sheet";
import { SearchTokenTable } from "./SearchTokenTable";

import { m } from "@laffer/foundation/paraglide/messages.js";

import type { PopoverRef } from "@laffer/applets-kit";
import type { PairId, /* PairUpdate, */ PerpsPairParam } from "@laffer/velox/types";
import type { AnyCoin } from "@laffer/store/types";
...
function normalizeRows(
  ...
  //   if (pair.baseDenom.includes("velox")) continue;
