import { Badge, Button, ResizerContainer, Tab, Tabs, createContext } from "@laffer/applets-kit";
...
const ReferralCampaignHeader: React.FC = () => (
  <div className="flex flex-col gap-8 w-full items-center relative">
    ...
    <Button
      variant="utility"
      onClick={() => window.open("https://velox-4.gitbook.io/velox-docs/referral-system")}
    >
