...
import type { TransportMode } from "@laffer/velox/utils";
...
import { useServiceStatus } from "@laffer/store";
...
export const StatusBadge: React.FC<StatusBadgeProps> = ({ className }) => {
  ...
  const { wsStatus, chainStatus, globalStatus, transportMode, isChainPaused, isReady } =
    useServiceStatus({ upUrl: window.velox.urls.upUrl });
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                onClick={() =>
                  window.open("https://status.velox.exchange/", "_blank", "noopener,noreferrer")
                }
              >
