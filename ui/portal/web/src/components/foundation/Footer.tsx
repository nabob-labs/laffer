...
import { allPerpsPairStatsStore, useAllPerpsPairStats } from "@laffer/store";
import { Decimal } from "@laffer/velox/utils";
import { m } from "@laffer/foundation/paraglide/messages.js";
import { useRouter } from "@tanstack/react-router";
import { StatusBadge } from "./StatusBadge";

import type { NormalizedPerpsPairStats } from "@laffer/store";
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1 shrink-0">
        <Link
          href="/documents/Velox - Terms of Use.pdf"
          target="_blank"
        ...
        <Link
          href="/documents/Velox - Privacy Policy.pdf"
          target="_blank"
          rel="noopener noreferrer"
          className="exposure-xs-italic"
        >
