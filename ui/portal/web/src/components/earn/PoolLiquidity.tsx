import { FormattedNumber, Modals, numberMask, Skeleton, useApp, useInputs } from "@laffer/applets-kit";
import { usePoolLiquidityState, usePrices } from "@laffer/store";
...
import type { PairUpdate } from "@laffer/velox/types";
