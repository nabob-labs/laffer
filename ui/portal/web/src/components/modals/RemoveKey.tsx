import { useAccount, useSigningClient, useSubmitTx } from "@laffer/store";
import { forwardRef } from "react";

import { m } from "@laffer/foundation/paraglide/messages.js";

import { Button, IconButton, IconClose, IconTrash, useApp } from "@laffer/applets-kit";

import type { KeyHash } from "@laffer/velox/types";
interface Props {
  keyHash: KeyHash;
}
