import { Badge, FormattedNumber, twMerge, useTheme } from "@laffer/applets-kit";
import { Decimal } from "@laffer/velox/utils";
import { getReferralLink, useAccount, useConfig } from "@laffer/store";
...
export function PreviewCard({
  ...
  const veloxLogoSrc = `/images/velox${theme === "dark" ? "-dark" : ""}.svg`;
  ...
  return (
    ...
    >
      <img src={veloxLogoSrc} alt="Velox" className="relative z-10 h-8 w-auto self-start" />
