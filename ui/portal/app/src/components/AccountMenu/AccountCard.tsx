...
import { usePublicClient } from "@laffer/store";
...
export const CARD_IMAGES = {
  dog: require("@laffer/foundation/images/characters/dog.svg"),
  puppy: require("@laffer/foundation/images/characters/puppy.svg"),
  froggo: require("@laffer/foundation/images/characters/froggo.svg"),
};
