import { useConfig, useFavPairs, usePrices } from "@laffer/store";

import { capitalize, formatUnits } from "@laffer/velox/utils";
...
import type { FormatNumberOptions } from "@laffer/velox/utils";
