import { createSessionSigner, createSignerClient } from "@laffer/velox";
...
import { encodeBase64 } from "@laffer/velox/encoding";
import type { SigningSession, SigningSessionInfo } from "@laffer/velox/types";
...
export function useSessionKey(parameters: UseSessionKeyParameters = {}): UseSessionKeyReturnType {
  ...
  const [channel] = useState(new BroadcastChannel("velox.session"));
