...
MAINNET_API_URL: Final[str] = "https://api-mainnet.velox.zone"
TESTNET_API_URL: Final[str] = "https://api-testnet.velox.zone"
LOCAL_API_URL: Final[str] = "http://localhost:8080"

CHAIN_ID_MAINNET: Final[str] = "velox-1"
CHAIN_ID_TESTNET: Final[str] = "velox-testnet-1"
