"""Tests for velox.exchange.Exchange — pipeline + margin methods."""
...
from velox.utils.constants import PERPS_CONTRACT_MAINNET, SETTLEMENT_DENOM
...
class TestConstruction:
    ...
    def test_chain_id_override_skips_query(self) -> None:
        ...
        info = FakeInfo()
        _exchange(info, chain_id="velox-1")
...
class TestDepositMargin:
    ...
    def test_rejects_bool(self) -> None:
        ...
        # Same hazard guarded by `velox_decimal`: bool is an int subtype
...
class TestWithdrawMargin:
    def test_amount_uses_six_decimal_string(self) -> None:
        ...
        # `velox_decimal` produces this canonical form.
...
class TestSendActionPipeline:
    ...
    def test_chain_id_propagates_into_metadata(self) -> None:
        ...
        info = FakeInfo()
        ex = _exchange(info, chain_id="velox-explicit-test")
        ex.deposit_margin(1_000_000)
        sent = info.broadcasted[-1]
        ...
        assert sent["data"]["chain_id"] == "velox-explicit-test"
