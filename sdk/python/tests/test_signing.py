"""Tests for velox.utils.signing — canonical JSON, Secp256k1 wallet, signing pipeline."""
...
from velox.utils.signing import (
    Secp256k1Wallet,
    Wallet,
    sign_doc_canonical_json,
    sign_doc_sha256,
)
from velox.utils.types import Addr, Metadata, Nonce, SignDoc, UserIndex
...
class TestCanonicalJson:
    ...
    def test_nested_keys_sorted_recursively(self) -> None:
        """Nested object keys are also sorted (matches bolt sort_all_objects)."""
    ...
    def test_utf8_encoding_no_ascii_escapes(self) -> None:
        ...
        doc: dict[str, object] = {"chain_id": "velox-é"}
        out = sign_doc_canonical_json(cast(SignDoc, doc))
    ...
    def test_golden_signdoc_byte_string(self) -> None:
        ...
        expected = (
            b'{"data":{"chain_id":"velox-1","nonce":0,"user_index":1},'
