...
from velox.utils.signing import Secp256k1Wallet
...
class FakeInfo:
    ...
    def query_status(self) -> dict[str, Any]:
        ...
        # `velox/_graphql/queries/queryStatus.graphql`): a `chainId` and
    ...
    def query_app_smart(
        ...
        **_: Any,
        ...
        # Velox's query enums are externally-tagged, so the variant name
        ...
        if "user" in msg:
            ...
            # contract — see `velox/types/src/account_factory/msg.rs`.
