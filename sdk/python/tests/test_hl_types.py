"""Tests for velox.hyperliquid_compatibility.types."""
...
class TestVeloxDecimalToHlStr:
    ...
    def test_multiple_digit_integer_no_scientific_notation(self) -> None:
        ...
        assert velox_decimal_to_hl_str("10") == "10"
        assert velox_decimal_to_hl_str("100") == "100"
        assert velox_decimal_to_hl_str("1000.000000") == "1000"

    def test_small_decimal(self) -> None:
        """Sub-unit values keep all significant digits."""

        assert velox_decimal_to_hl_str("0.000001") == "0.000001"

    def test_large_with_trailing_zeros(self) -> None:
        """Stress: large value with mixed trailing zeros."""

        assert velox_decimal_to_hl_str("1234567.890000") == "1234567.89"

    def test_negative_zero_fraction(self) -> None:
        """A negative number with all-zero fraction loses the fraction."""

        assert velox_decimal_to_hl_str("-100.000000") == "-100"
    ...
    def test_signed_zero_collapses_to_unsigned(self) -> None:
        ...
        assert velox_decimal_to_hl_str("-0.000000") == "0"
        assert velox_decimal_to_hl_str("-0") == "0"
        assert velox_decimal_to_hl_str("-0.0") == "0"

    def test_preserves_high_precision(self) -> None:
        """Inputs that don't have trailing zeros are preserved as-is."""

        assert velox_decimal_to_hl_str("3.141592") == "3.141592"
