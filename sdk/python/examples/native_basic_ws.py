"""Native Velox API: subscribe to trades, candles, user events, and blocks."""
...
from velox.utils.constants import PERPS_CONTRACT_TESTNET, TESTNET_API_URL
...
def main() -> None:
    ...
    # VELOX_ACCOUNT_ADDRESS required).
    ...
    # `{"_error": ...}` (see `velox.info._unwrap_node`).
    sub_ids: list[int] = []
