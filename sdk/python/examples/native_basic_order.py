"""Native Velox API: place, query, and cancel a single resting limit order."""
...
from velox.utils.types import Addr, OrderId, PairId, TimeInForce
...
def main() -> None:
    ...
    # shape — see `velox/types/src/perps.rs::UserState`. `positions` is
