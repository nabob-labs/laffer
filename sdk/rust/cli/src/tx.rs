use {
    ...
    velox_sdk::{HttpClient, Keystore, Secp256k1, Secret, SingleSigner},
    velox_types::{account_factory::UserIndex, config::AppConfig},
    bolt_app::GAS_COSTS,
    bolt_types::{
...
enum SubCmd {
    ...
    Upgrade {
        ...
        height: u64,
        /// Version of the velox CLI binary to use
        cargo_version: String,
        /// Git tag of the velox CLI binary to use
