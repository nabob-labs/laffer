//! Subscribe to all `order_filled` events on Velox mainnet over WebSocket,
...
//!
//! ```sh
//! cargo run -p velox-sdk --example subscribe_order_filled
//! ```
...
const WS_URL: &str = "wss://api-mainnet.velox.zone/graphql";
