...
import type { Chain, Prettify, Transport, Tx, TxData, UnsignedTx } from "@laffer/sdk/types";

import { withRetry } from "@laffer/sdk/utils";
...
export async function broadcastTxSync<transport extends Transport>(
  client: VeloxClient<transport, undefined | Signer>,
