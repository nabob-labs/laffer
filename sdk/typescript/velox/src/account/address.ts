import { Sha256, ripemd160 } from "@laffer/sdk/crypto";
import { decodeHex, encodeHex, isHex } from "@laffer/sdk/encoding";
import type { Address, Hex } from "@laffer/sdk/types";
 ...
 *
 * Mirrors that Rust function: `bolt::Addr::derive`.
 * @param parameters
